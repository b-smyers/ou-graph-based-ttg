...
{ "type": "CREDITS_FROM", "credits_required": 9, "requirements": [ <requisite-objects> ] }
# credits_required: the total number of **credits** that must be taken from classes from "requirements"

{ "type": "CHOOSE_N", "choose": 3, "requirements": [ <requisite-objects> ] }
# choose: the total number of **courses** that must be taken from "requirements"
